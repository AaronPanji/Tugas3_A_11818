...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1818</h1>", unsafe_allow_html=True)  # XXXX = 4 digit npm terakhir
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\KULIAH\Machine Learning\Model Suprevised Learning (Praktek)\Tugas3_A_11818'
    model_path = os.path.join(model_directory, r'LR_IPK_model.pkl')
